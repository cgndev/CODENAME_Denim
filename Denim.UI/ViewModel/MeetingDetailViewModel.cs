...
namespace Denim.UI.ViewModel
{
    public class MeetingDetailViewModel : DetailViewModelBase, IMeetingDetailViewModel
    {
        ...
        {
            var meetingFrendIds = Meeting.Model.Friends.Select(f => f.Id).ToList();
            var addedFriends = _allFriends.Where(f => meetingFrendIds.Contains(f.Id)).OrderBy(f => f.LastName);
            var availableFriends = _allFriends.Except(addedFriends).OrderBy(f => f.LastName);
